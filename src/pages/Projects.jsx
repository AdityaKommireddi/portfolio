  ...
  return (
    <div className="projects-container">
      ...
      <div className="project-card">
        ...
        <a href="https://github.com/AdityaKommireddi/NLP-Project" target="_blank" rel="noreferrer">View on GitHub</a>
      </div>

      <div className="project-card">
        <h2>BidEval AI</h2>
        <p>An automated evaluation tool for government procurement bids, built using Streamlit and Gemini 1.5 Pro.</p>
        <a href="https://github.com/Jeevjoel/BidEvalUI" target="_blank" rel="noreferrer">View on GitHub</a>
      </div>
    </div>
  );
}
